...
public class KudosAlreadyLinkedException extends Exception {
  ...
  public KudosAlreadyLinkedException(final String s) {
    super(s);
  }

  public KudosAlreadyLinkedException(final String s, final Throwable throwable) {
    super(s, throwable);
  }

  public KudosAlreadyLinkedException(final Throwable throwable) {
    super(throwable);
  }
}
