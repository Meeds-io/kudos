...
import static org.exoplatform.addon.kudos.statistic.StatisticUtils.*;
...
public class ExoKudosStatisticAspect {
  ...
  /**
   * Encapsulate method annotated with {@link ExoKudosStatistic} to add
   * statistic log entry
   * 
   ...
   */
  @Around("execution(* *(..)) && @annotation(org.exoplatform.addon.kudos.statistic.ExoKudosStatistic)")
